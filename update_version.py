...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright BradGuesman, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/ReplicantDelay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReplicantDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReplicantDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReplicantDelay-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReplicantDelay-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReplicantDelay-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/ReplicantDelay-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/ReplicantDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ReplicantDelay.iss",inplace=1):
